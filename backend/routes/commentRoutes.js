...
router.get('/read/:postId', commentCtrl.readAllComments); //Affiche la liste des commentaires d'un post
...
router.get('/readall', commentCtrl.readComments); //Affiche la liste des commentaires signalés
